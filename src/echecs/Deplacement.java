...
public class Deplacement {
    ...
    public Deplacement(Position p1, Position p2, char pieceCode, char color){//for the execution in YACG
        x1 = p1.getX();
        y1 = p1.getY();
        x2 = p2.getX();
        y2 = p2.getY(); 
    ...
    public String toString(){
       // return (new Position(x1,y1)).toString()+" � "+(new Position(x2,y2)).toString();//not working anymore
